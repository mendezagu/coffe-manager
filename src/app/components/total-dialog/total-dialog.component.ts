      ...
      <html>
        <head>
          ...
          <style>
            ...
            body { 
              ...
              font-size: 14px; /* Aseguramos un tamaño de texto adecuado */
              font-weight: bold;
              margin: 0;
              padding: 0;
              text-align: left;
          ...
          .logo img {
            width: 70px;  /* Ajusta la imagen al ancho de la página */
            height: auto;
            max-width: 58mm;  /* Limita el ancho máximo a 58mm */
          }
        ...
        <body>
          ...
          <div class="logo">
            ...
            <div class="header">
              <h2 style="font-size: 14px; margin-left: 2.5rem">🍽️ NUOVO CAFFE</h2>
                <div class="line"></div>
              <p><strong style="font-size: 10px;">Documento no valido como factura</strong></p>
               <p><strong style="font-size: 10px;">Pida su factura en caja</strong></p>
                <p><strong style="font-size: 10px;">Libertad 321</strong></p>
                <p><strong style="font-size: 10px;">Santa rosa de calamuchita</strong></p>
            ...
            <div class="line"></div>
            <p style="text-align:center; font-size:14px;"><br></p>
          </div>
          <script>
            window.print();
